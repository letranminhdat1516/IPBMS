...
import 'package:detect_care_app/core/models/device_health.dart';
    ...
    try {
      ...
      if (response.statusCode < 200 || response.statusCode >= 300) {
        ...
        if (response.statusCode == 401) {
          ...
          // Don't create offline alert for auth errors, just return
          return;
        }
      ...
      // Create offline alert if we can't reach the device
    ...
    try {
      ...
      if (response.statusCode < 200 || response.statusCode >= 300) {
        ...
        if (response.statusCode == 401) {
          ...
          // Don't throw here, just return empty list and let the service handle it
          return [];
        }
      ...
      // Handle the actual data (could be List or Map with devices/items)
      if (data is List) {
        debugPrint(
