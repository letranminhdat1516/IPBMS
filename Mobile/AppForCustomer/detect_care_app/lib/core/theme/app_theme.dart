...
class AppTheme {
  // Primary Colors
  // Fresher/brighter primary blue (used as main brand color)
  // Primary: #2563EB (brighter/fresher blue)
  static const Color primaryBlue = Color(0xFF2563EB);
  // Darker tone for elevated/pressed states
  static const Color primaryBlueDark = Color(0xFF1E40AF);
  // Light tint used for subtle filled backgrounds (approx 14% tint)
  static const Color primaryBlueLight = Color(0xFFDBEAFE);
  static const Color secondaryBlue = Color(
    0xFF60A5FA,
  ); // Added for theme consistency
  static const Color error = Color(0xFFE53E3E); // Added for error color usage
  ...
  static ThemeData get lightTheme {
    // Material 3 ColorScheme: use fresher primary blue as seed
    const Color seedPrimary = Color(0xFF2563EB); // Fresher blue
    ColorScheme colorScheme =
        ColorScheme.fromSeed(
          ...
          primary: seedPrimary,
          // Primary container used for selected chips / tabs (soft blue tint)
          primaryContainer: const Color(0xFFDBEAFE),
          // Secondary: supporting neutral/accent blue
          secondary: const Color(0xFF60A5FA),
          // Neutral: map to the newer surfaceContainerHighest slot
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          elevation: 0,
          shadowColor: primaryBlue.withValues(alpha: 77),
