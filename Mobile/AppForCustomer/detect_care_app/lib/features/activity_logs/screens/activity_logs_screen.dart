...
import 'package:detect_care_app/features/activity_logs/data/activity_logs_remote_data_source.dart';
import 'package:detect_care_app/features/activity_logs/models/activity_log.dart';
  ...
  Widget _buildFilterBar() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: primaryBlue.withAlpha((0.05 * 255).round()),
            blurRadius: 10,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: primaryBlue.withAlpha((0.04 * 255).round()),
            blurRadius: 8,
...
class _LogDetailSheet extends StatelessWidget {
  ...
  Widget _buildInfoSection() {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: lightBlue.withAlpha((0.3 * 255).round()),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: primaryBlue.withAlpha((0.1 * 255).round()),
          width: 1,
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(0xFFEF4444).withAlpha((0.05 * 255).round()),
              blurRadius: 20,
              offset: const Offset(0, 8),
            ),
          ],
