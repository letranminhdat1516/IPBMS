                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if ((habit.sleepStart != null &&
                              habit.sleepStart!.isNotEmpty) ||
                          (habit.sleepEnd != null &&
                              habit.sleepEnd!.isNotEmpty))
                        Text(
                          'Giờ ngủ: ${habit.sleepStart ?? "-"} - ${habit.sleepEnd ?? "-"}',
                          style: const TextStyle(
                            fontSize: 15,
                            color: Color(0xFF64748B),
                          ),
                      ...
                      if (habit.notesString != null &&
                          habit.notesString!.isNotEmpty)
                        Text(
                          'Ghi chú: ${habit.notesString}',
                          style: const TextStyle(
                            fontSize: 15,
                            color: Color(0xFF64748B),
                          ),
                        ),
                      if (habit.notesMap != null && habit.notesMap!.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.only(top: 6),
                          child: Text(
                            'Ghi chú: ${habit.notesMap!.entries.map((e) => '${e.key}: ${e.value}').join(', ')}',
                            style: const TextStyle(
                              fontSize: 15,
                              color: Color(0xFF64748B),
                            ),
