import 'package:detect_care_app/features/health_overview/data/health_report_service.dart';
              ...
              Material(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    if (picked != null) {
                      // Enforce a two-day range (start .. start+1 day).
                      ...
                      if (endDate.isAfter(todayDate)) {
                        // clamp to yesterday..today
                        final yesterday = todayDate.subtract(
                          const Duration(days: 1),
                        );
                        onRangeSelected(
                          DateTimeRange(start: yesterday, end: todayDate),
                        );
                      } else {
                        onRangeSelected(
