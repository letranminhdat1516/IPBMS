...
export enum EventLifecycleEnum {
  CANCELED = 'CANCELED',
  NOTIFIED = 'NOTIFIED',
  AUTOCALLED = 'AUTOCALLED',
  ALARM_ACTIVATED = 'ALARM_ACTIVATED',
  ACKNOWLEDGED = 'ACKNOWLEDGED',
  EMERGENCY_RESPONSE_RECEIVED = 'EMERGENCY_RESPONSE_RECEIVED',
  RESOLVED = 'RESOLVED',
  EMERGENCY_ESCALATION_FAILED = 'EMERGENCY_ESCALATION_FAILED',
}

/**
 * Event entity - maps to 'event_detections' table in database
 * NOTE: In Prisma schema, this is defined as:
 *   model events {
